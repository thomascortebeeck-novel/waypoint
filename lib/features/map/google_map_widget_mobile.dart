...
class _GoogleMapWidgetMobileState extends State<GoogleMapWidget> {
  ...
  Timer? _scaleDebounce; // Debounce marker rescale after zoom/resize (300ms)
  ...
  void didUpdateWidget(GoogleMapWidget oldWidget) {
    ...
    // Resize markers when map width changes (debounced to avoid heavy raster regeneration)
      ...
      children: [
        gmaps_mobile.GoogleMap(
          ...
          onLongPress: widget.onLongPress != null
              ...
              : null,
          onCameraMove: (gmaps_mobile.CameraPosition position) {
