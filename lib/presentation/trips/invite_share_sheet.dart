...
class _InviteShareSheetState extends State<InviteShareSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final isReady = widget.trip.isReadyForInvites;
    
    // Show "not ready" state if trip customization is not complete
    if (!isReady) {
      return Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Before inviting friends, please finish selecting waypoints for each day of your trip.',
